...
namespace TestProject
{
    ...
    public class HeadShieldBuster : MonoBehaviour, IBulletVisitor, IRoketVisitor
    {
        ...
        public void TakeDamge(int damage, Collision2D collision, bool fromLeft)
        {
            ...
            {
                Debug.Log("Heal");
                bullet.Owner.ActivateHeadShield();
            }
        ...
        public class Factory : PlaceholderFactory<HeadShieldBuster> { }
